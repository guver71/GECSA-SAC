...
@section('page-title', 'Nuevo Expediente Técnico')
...
<div class="admin-form-card">
  <div class="card-header">
    <i class="bi bi-plus-circle-fill me-2"></i>Registrar Nuevo Expediente Técnico
  </div>
  <div class="card-body">
      ...
      <div class="row g-4">
        <div class="col-12">
          ...
          <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                 value="{{ old('title') }}" placeholder="Ej: Agua Potable – 9 de Octubre, Quillca">
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="snip" class="form-control @error('snip') is-invalid @enderror"
                 value="{{ old('snip') }}" placeholder="Ej: 381923">
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="fecha_contrato" class="form-control @error('fecha_contrato') is-invalid @enderror"
                 value="{{ old('fecha_contrato') }}" placeholder="DD/MM/AAAA">
